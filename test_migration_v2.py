...
def execute_migration_cycle_v2(task_id: int = 2):
    ...
    # Валидация задачи - пропускаем для тестовой миграции
    console.print(f'[yellow]⚠️  Пропускаем валидацию задачи для тестовой миграции[/yellow]')
...
def main(task_id: int = 2):
    ...
    # Валидация задачи - пропускаем проверку для тестовой миграции
    console.print(f'[yellow]⚠️  Пропускаем валидацию задачи для тестовой миграции[/yellow]')
